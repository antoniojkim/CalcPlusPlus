...
TEST_CASE("Matrix Multiplication Tests", "[matmul]" ) {
    ...
    requireExprIsEqual("{{1, 0, 0}, {2, -1, 2}, {4, -4, 5}} * {{0}, {-0.4472135954999579}, {-0.8944271909999159}}",
                       "{{0}, {-1.341640786499874}, {-2.683281572999748}}");
...
TEST_CASE("Matrix Scalar Operation Tests", "[matscalar]"){
    ...
    SECTION("Matrix Scalar Division"){
        ...
        requireExprIsEqual("2 / {{1, 2}, {3, 4}}", "{{2, 1}, {2/3, 0.5}}");
    }
...
TEST_CASE("Matrix Inverse Tests", "[inverse]"){
    ...
    SECTION("Complex Matrix Inverse Tests"){
        requireExprIsEqual("{{i, 2}, {3, 4i}}^-1", "{{-0.4i, 0.2}, {0.3, -0.1i}}");
