...
TEST_CASE("Matrix Inverse Tests", "[transpose]"){
    ...
    SECTION("Complex Matrix Inverse Tests"){
        requireExprIsEqual("{{1i, 2}, {3, 4i}}^-1", "{{{0.0, -0.4},{0.2, 0.0}},  {{0.3, 0.0},{0.0, -0.1}}}");
        requireExprIsEqual("{{10, -9i, -12}, {7, -12, 11i}, {-10i, 10, 3}}^-1",
                        "{{0.0568283247+0.0698351186, 0.0796074604-0.0530825327i, 0.0326773457-0.012553547i}, {-0.0646285282+0.0248281262, 0.0116912281+0.0955086199i, 0.0916841601+0.0564446685i}, {-0.0173553014+0.1066673283i, 0.1379710152-0.053003865i, 0.0695646228-0.0792244093i}}");
    }
