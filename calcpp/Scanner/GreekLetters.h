...
namespace calcpp {
    ...
    constexpr const char* greekLetterNames[numGreekLetters] = {
        ...
        "Rho", "Sigma", "Tau", "Theta", "Upsilon", "Xi", "Zeta", "alpha",
        "beta", "chi", "delta", "epsilon", "eta", "gamma", "iota", "kappa",
    ...
    constexpr const int greekLetterIndices[numGreekLetters] = {
        ...
        0, 1, 21, 3, 4, 6, 2, 8, 9, 10, 11, 12, 23, 14, 20, 15, 22, 16, 17, 18,
        7, 19, 13, 5, 24, 25, 45, 27, 28, 30, 26, 32, 33, 34, 35, 36, 47, 38,
        44, 39, 46, 40, 41, 42, 31, 43, 48, 37, 29
        // end sourcegen
    };
