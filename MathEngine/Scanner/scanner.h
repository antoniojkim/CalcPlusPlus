...
namespace Scanner {
	...
	enum Type {
		...
		LPAREN, RPAREN, LSQUARE, RSQUARE, LBRACE, RBRACE, DOT, SEMICOLON, QUESTION, POUND,
	...
	constexpr int numTokens = 61;
	static const std::string typeStrings[numTokens] = {
		"HEX", "BIN", "NUM", "ID", "SPECIALID", "FUNCTION", "TUPLE", "MATRIX", "INVALID",
		"UNIT", "VAR", "VARARGS", "LPAREN", "RPAREN", "LSQUARE", "RSQUARE", "LBRACE", "RBRACE",
		"DOT", "SEMICOLON", "QUESTION", "POUND", "DOLLAR", "QUOTE", "BACKSLASH", "BACKTICK",
		"UNDERSCORE", "COMMA", "EQUALS", "COLON_EQUALS", "L_ARROW", "R_ARROW", "ELLIPSIS",
		"PIPE_PIPE", "AMP_AMP", "PIPE", "CARET_PIPE", "AMP", "EQUALS_EQUALS", "NOT_EQUALS",
		"LT", "GT", "LT_EQ", "GT_EQ", "TILDE", "APOSTROPHE", "LT_LT", "GT_GT", "PLUS", "MINUS",
		"STAR", "SLASH", "PCT", "SLASH_SLASH", "EXCL", "EXCL_EXCL", "CHOOSE", "PERMUTE",
		"CARET", "STAR_STAR", "COLON"
	};
