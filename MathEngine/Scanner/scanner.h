...
namespace Scanner {
	...
	enum Type {
		...
		LT, GT, LT_EQ, GT_EQ, TILDE, LT_LT, GT_GT, PLUS, MINUS, STAR, SLASH, PCT, SLASH_SLASH,
		EXCL, EXCL_EXCL, CHOOSE, PERMUTE, CARET, STAR_STAR, COLON, LPAREN, RPAREN, LSQUARE,
	...
	static const std::string typeStrings[numTokens] = {
		...
		"TILDE", "LT_LT", "GT_GT", "PLUS", "MINUS", "STAR", "SLASH", "PCT", "SLASH_SLASH",
		"EXCL", "EXCL_EXCL", "CHOOSE", "PERMUTE", "CARET", "STAR_STAR", "COLON", "LPAREN",
		"RPAREN", "LSQUARE", "RSQUARE", "LBRACE", "RBRACE", "DOT", "SEMICOLON", "QUESTION",
		"POUND", "DOLLAR", "QUOTE", "APOSTROPHE", "BACKSLASH", "BACKTICK", "UNDERSCORE", "C",
		"P"
	};
