...
namespace Function {
    ...
    const struct __csc__: public Function::ValueFunction {
        ...
        double value(double x) const override { return 1.0 / std::sin(x); }
        expression derivative(Function::Args& args, const std::string& var) const override {
    ...
    const struct __sec__: public Function::ValueFunction {
        ...
        double value(double x) const override { return 1.0 / std::cos(x); }
        expression derivative(Function::Args& args, const std::string& var) const override {
    ...
    const struct __cot__: public Function::ValueFunction {
        ...
        double value(double x) const override { return 1.0 / std::tan(x); }
        expression derivative(Function::Args& args, const std::string& var) const override {
    ...
    const struct __acsc__: public Function::ValueFunction {
        ...
        double value(double x) const override { return std::asin(1.0 / x); }
        expression derivative(Function::Args& args, const std::string& var) const override {
    ...
    const struct __asec__: public Function::ValueFunction {
        ...
        double value(double x) const override { return std::acos(1.0 / x); }
        expression derivative(Function::Args& args, const std::string& var) const override {
            using ExpressionMath::abs, ExpressionMath::sqrt;
            auto x = args["x"];
            return 1 / (abs(x) * sqrt((x ^ 2) - 1));
    ...
    const struct __acot__: public Function::ValueFunction {
        ...
        double value(double x) const override { return (x > 0 ? M_PI_2 : -M_PI_2) - std::atan(x); }
        expression derivative(Function::Args& args, const std::string& var) const override {
            auto x = args["x"];
            return -1 / (1 + (x ^ 2));
        }
    ...
    const struct __csch__: public Function::ValueFunction {
        ...
        double value(double x) const override { return 1.0 / std::sinh(x); }
        expression derivative(Function::Args& args, const std::string& var) const override {
    ...
    const struct __sech__: public Function::ValueFunction {
        ...
        double value(double x) const override { return 1.0 / std::cosh(x); }
        expression derivative(Function::Args& args, const std::string& var) const override {
    ...
    const struct __coth__: public Function::ValueFunction {
        ...
        double value(double x) const override { return 1.0 / std::tanh(x); }
        expression derivative(Function::Args& args, const std::string& var) const override {
