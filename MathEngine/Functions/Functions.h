...
namespace Functions {
    constexpr const int numFunctions = 160;
    constexpr const char* names[numFunctions] = {
        "%", "&", "*", "**", "+", "-", "/", "//", ":=", "<-", "<<", "=", ">>", "Beta",
        "Betainc", "C", "Cholesky", "LU", "LUsolve", "P", "^", "^|", "abs", "absdev", "acos",
        "acosh", "acot", "acoth", "acsc", "acsch", "arccos", "arccosh", "arccot", "arccoth",
        "arccsc", "arccsch", "arcos", "arcosh", "arcot", "arcoth", "arcsc", "arcsch", "arcsec",
        "arcsech", "arcsin", "arcsinh", "arctan", "arctanh", "argmax", "argmin", "arsec",
        "arsech", "arsin", "arsinh", "artan", "artanh", "asec", "asech", "asin", "asinh",
        "atan", "atanh", "autocorr", "bin", "cb", "cbrt", "choose", "comb", "cos", "cosh",
        "cot", "coth", "csc", "csch", "cubic", "cubicc", "deg", "deriv", "det", "dfact", "diff",
        "exp", "exp2", "expm1", "fact", "fcmp", "fft", "frexp", "gamma", "gamma_inc",
        ...
        "log2", "logabs", "logn", "max", "max_index", "mean", "median", "min", "min_index",
        "neg", "num", "perm", "permute", "poch", "pochrel", "quad", "quadc", "rad", "sd", "sec",
        "sech", "sin", "sinh", "skew", "solve", "sqr", "sqrt", "std", "stdev", "tan", "tanh",
