...
namespace Functions {
    ...
    constexpr const char* names[numFunctions] = {
        "%", "&", "*", "**", "+", "-", "/", "//", "<<", ">>", "Beta", "Betainc", "C",
        "Cholesky", "LU", "LUsolve", "P", "^", "^|", "abs", "absdev", "acos", "acosh", "acot",
        "acoth", "acsc", "acsch", "arccos", "arccosh", "arccot", "arccoth", "arccsc", "arccsch",
        "arcos", "arcosh", "arcot", "arcoth", "arcsc", "arcsch", "arcsec", "arcsech", "arcsin",
        "arcsinh", "arctan", "arctanh", "argmax", "argmin", "arsec", "arsech", "arsin",
        "arsinh", "artan", "artanh", "asec", "asech", "asin", "asinh", "atan", "atanh",
