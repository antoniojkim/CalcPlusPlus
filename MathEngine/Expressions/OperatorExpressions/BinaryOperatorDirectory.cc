...
const BinaryOperator binaryOperators[numTokens] = {
	...
	f_EQUALS, f_COLON_EQUALS, f_L_ARROW, f_PIPE_PIPE, f_AMP_AMP, f_PIPE,
	f_CARET_PIPE, f_AMP, f_EQUALS_EQUALS, f_NOT_EQUALS, f_LT, f_GT, f_LT_EQ,
	f_GT_EQ, nullptr, f_LT_LT, f_GT_GT, f_PLUS, f_MINUS, f_STAR, f_SLASH, f_PCT,
	f_SLASH_SLASH, nullptr, f_CARET, f_STAR_STAR, f_R_ARROW, f_COLON, nullptr,
